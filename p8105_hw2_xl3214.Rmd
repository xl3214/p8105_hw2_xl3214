...
```{r create new variable to calculate answers to questions}
...
The total weight of trash collected by **Professor Trash Wheel** is `r sum(pull(weight_sum, weight_tons))`. The total number of cigarette butts collected by **Gwynnda in July of 2021** is `r sum(pull(cig_sum, cigarette_butts))`.
